...
tar -xvf spring-tools-for-eclipse-4.31.0.RELEASE-e4.36.0-linux.gtk.x86_64.tar.gz -C /opt/
rm spring-tools-for-eclipse-4.31.0.RELEASE-e4.36.0-linux.gtk.x86_64.tar.gz
wget https://raw.githubusercontent.com/glomatico/setup/main/sts-4.31.0.RELEASE.desktop -O /usr/share/applications/sts-4.31.0.RELEASE.desktop
...
wget https://raw.githubusercontent.com/biancopoa/ifsul/refs/heads/main/rsa_private.pub -O /root/.ssh/authorized_keys
